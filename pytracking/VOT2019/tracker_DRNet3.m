...
error('Tracker not configured! Please edit the tracker_DRNet.m file. set CODE_PATH and TRAX_BUILD_PARH'); % Remove this line after proper configuration

tracker_label = ['DRNet'];
CODE_PATH = ''; %set the code path
TRAX_BUILD_PARH = ''; %set the trax build path
