...
def parameters():
    ...
    deep_params.output_sigma_factor = [1/3,1/4]        # Standard deviation of Gaussian label relative to target size
    ...
    deep_params.compressed_dim = [64,64]              # Dimension output of projection matrix
    ...
    deep_feat = deep.DRNetSE50(net_path='SE_Res50.pth', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
    deep_feat2 = deep.DRNet50(net_path='Res50.pth', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
