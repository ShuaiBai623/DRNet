...
def parameters():
    ...
    params.scale_factors = torch.ones(1)#1.02**torch.arange(-2, 3).float()     # What scales to use for localization
    ...
    features = deep.DRNet50(net_path='DRNet_ep0022.pth', output_layers=['layer2','layer3'], use_gpu=params.use_gpu, fparams=fparams,
                                  normalize_power=2)
