...
def run(settings):
    ...
    settings.description = 'DRNet with default settings.'
    ...
    # Create network
    net = DR_models.drnet_se_resnet50(backbone_pretrained=True)
    # Set objective
    objective = nn.SmoothL1Loss()

    # Create actor, which wraps network and objective
    actor = actors.DRActor(net=net, objective=objective)
