...
def atom_resnet18(iou_input_dim=(256,256), iou_inter_dim=(256,256), backbone_pretrained=True):
    ...
    return net
@model_constructor
def atom_resnet50(iou_input_dim=(512,1024), iou_inter_dim=(256,256), backbone_pretrained=True):
    # backbone
    backbone_net = backbones.resnet50(pretrained=backbone_pretrained)
    if backbone_pretrained:
        mod = torch.load('/mnt/lustre/baishuai/experiment/pytracking_networks/rpn_r50_c4_2x-3d4c1e14.pth')['state_dict']
    ...
    # Bounding box regressor
    iou_predictor = bbmodels.AtomIoUNet(input_dim=iou_input_dim, pred_inter_dim=iou_inter_dim)
    ...
    return net
@model_constructor
def atom_se_resnet50(iou_input_dim=(512,1024), iou_inter_dim=(256,256), backbone_pretrained=True):
    # backbone
