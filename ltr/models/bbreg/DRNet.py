...
@model_constructor
def drnet_resnet18(iou_input_dim=(256,256), iou_inter_dim=(256,256), backbone_pretrained=True):
    # backbone
    backbone_net = backbones.resnet18(pretrained=backbone_pretrained)

    # Bounding box regressor
    iou_predictor = bbmodels.DirectReg(pred_input_dim=iou_input_dim, pred_inter_dim=iou_inter_dim)
